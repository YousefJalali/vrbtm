...
export default function SelectNotebook() {
  ...
  const notebooks = [
    { id, name: "math", color: "#E32F22" },
    { id, name: "physics", color: "#422F8A" },
    { id, name: "biology", color: "#5DA842" },
    { id, name: "history", color: "#3B59A2" },
    { id, name: "history 2s", color: "#3B59A2" },
    { id, name: "art", color: "#009e6f" },
    { id, name: "art 2", color: "#009e6f" },
    { id, name: "art 3", color: "#009e6f" },
  ]
        ...
        <div className="overflow-hidden rounded-2xl border">
          ...
          <div className="relative max-h-[calc(48px*7.5)] overflow-y-scroll">
            <ul className="menu  w-full bg-base-100 ">
              ...
              {notebooks.splice(0, 1).map((notebook) => (
                <li key={notebook.id}>
                  <a>
              ...
              {sortBy(notebooks, ["name"]).map((notebook, i, array) => {
                return (
                  <>
                    {(i === 0 ||
